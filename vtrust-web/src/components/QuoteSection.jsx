    ...
    <section ref={revealRef} className={`quote-section container py-20 mb-8 reveal ${isVisible ? 'is-visible' : ''}`} id="boicanh">
      <div className="flex-col items-center text-center">
        ...
        <div style={{ maxWidth: '900px', margin: '0 auto', fontSize: '1.1rem', lineHeight: '1.8', fontWeight: '500' }}>
          ...
          <p className="text-red" style={{ fontWeight: '700', fontSize: '1.2rem', marginTop: '30px' }}>
            Thành công của Local Brand không phải ngẫu nhiên, mà là “mùa quả ngọt” khi đường lối kiến tạo đúng đắn của Đảng gặp gỡ bản lĩnh kiên cường của doanh nghiệp Việt.
          </p>
        </div>
      </div>
    </section>
